...
): RecyclerView.Adapter<List1Adapter.ViewHolder>(){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): List1Adapter.ViewHolder {
        return ViewHolder(
            LayoutInflater.from( parent.context ).inflate( R.layout.list1_layout, parent, false )
        )
    }

    override fun onBindViewHolder(holder: List1Adapter.ViewHolder, position: Int) {
